          ...
          <table className="min-w-[3600px] w-full border-collapse text-sm">
            <thead className="sticky top-0 z-20 shadow-[0_2px_4px_-1px_rgba(0,0,0,0.1)]">
              <tr className="bg-table-header">
                ...
                <th rowSpan={2} className={`${thBase} min-w-[24px] w-[24px] max-w-[24px] !px-0 border-r-0`}></th>
              </tr>
              <tr className="bg-table-header">
                ...
                <th className={`${thBase} min-w-[70px] w-[70px] max-w-[70px] bg-table-header-gas`}>예정/완료</th>
                <th className={`${thBase} min-w-[40px] w-[40px] max-w-[40px] bg-table-header-gas`}>S/O발행</th>
                <th className={`${thBase} min-w-[40px] w-[40px] max-w-[40px] bg-table-header-gas`}>S/O도착</th>
                ...
                <th className={`${thBase} min-w-[70px] w-[70px] max-w-[70px] bg-table-header-velocity`}>예정/완료</th>
              ...
              {filtered.map((item, idx) => {
                ...
                return (
                  <tr key={item.id} className={`group ${rowBg} transition-colors ${isSiteStart ? "[&>td]:shadow-[inset_0_1px_0_0_rgb(170,167,167)]" : "border-b border-border/20"}`}>
                    ...
                    <td className={`${td} text-center !px-0 min-w-[24px] w-[24px] max-w-[24px] border-r-0`}>
                      <button
