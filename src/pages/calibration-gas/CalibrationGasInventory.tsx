          ...
          <table className="min-w-[3600px] w-full border-collapse text-sm">
            ...
            <tbody>
              {filtered.map((item, idx) => {
                ...
                const isUnitStart = s.unit > 0 && idx > 0 && !isSiteStart;
                ...
                return (
                  <tr key={item.id} className={`group ${rowBg} transition-colors ${isSiteStart ? "[&>td]:shadow-[inset_0_1px_0_0_rgb(170,167,167)]" : isUnitStart ? "[&>td]:shadow-[inset_0_1px_0_0_#D4D4D4]" : "border-b border-border/20"}`}>
