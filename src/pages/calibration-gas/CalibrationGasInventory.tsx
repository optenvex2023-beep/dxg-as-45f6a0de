          ...
          <table className="min-w-[3600px] w-full border-collapse text-sm">
            ...
            <tbody>
              {filtered.map((item, idx) => {
                ...
                return (
                  <tr key={item.id} <tr key={item.id} className={`${rowBg} hover:bg-accent/40 transition-colors ${isSiteStart ? "border-t-[1.5px] border-t-muted-foreground/60" : "border-b border-border/20"}`}>>
